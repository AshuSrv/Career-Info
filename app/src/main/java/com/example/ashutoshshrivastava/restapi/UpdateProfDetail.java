...
public class UpdateProfDetail extends AppCompatActivity {
    EditText skills,mobile,name,link;
    Button submit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_prof_detail);
        ...
        skills.setText(end);
        mobile.setText(organisation);
        name.setText(designation);
        link.setText(start_date);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(skills.getText()) || TextUtils.isEmpty(name.getText()) || TextUtils.isEmpty(mobile.getText()) || TextUtils.isEmpty(link.getText())) {
                    ...
                    Toast.makeText(UpdateProfDetail.this, "Some Fields are Blank", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    loginInterface.Updatefillprofdetail(Integer.parseInt(id), professionalDetailClass).enqueue(new Callback<ProfessionalDetailClass>() {
                        @Override
                        public void onResponse(Call<ProfessionalDetailClass> call, Response<ProfessionalDetailClass> response) {
                            ...
                            Intent intent = new Intent(UpdateProfDetail.this, Professionaldetails.class);
                            Toast.makeText(UpdateProfDetail.this, "Update Successful", Toast.LENGTH_LONG).show();
                        ...
                        public void onFailure(Call<ProfessionalDetailClass> call, Throwable t) {
                            Toast.makeText(UpdateProfDetail.this, "Failed To Update Professional details", Toast.LENGTH_LONG).show();
                        }
                    });
